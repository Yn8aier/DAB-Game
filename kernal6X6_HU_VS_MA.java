...
public class kernal6X6_HU_VS_MA {
    ...
    public void computer1Play() {
        ...
        for (; ; ) {
            ...
            if (isRepeat(index) == true) {
                ...
                kernal6X6_HU_VS_MA.updateArrays(index);
                order.add(index);
...
//        }
        for (int i = 0; i < order.size(); i++) {
            kernal6X6_HU_VS_MA.updateArrays(order.get(i));
            if (testFour(currX, currY, MainFrame_6X6.getPlayer()) == true) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        kernal6X6_HU_VS_MA game = new kernal6X6_HU_VS_MA();
