...
public class kernal7X7_HU_VS_MA {
...
//                }
    ...
    public void computer1Play() {
        ...
        for (; ; ) {
            ...
            if (isRepeat(index) == true) {
                ...
                kernal7X7_HU_VS_MA.updateArrays(index);
                order.add(index);
                MainFrame_7X7.getGUIedges().get(index).setFree(false);
                MainFrame_7X7.getGUIedges().get(index).setColor(Color.RED);
                MainFrame_7X7.getGUIedges().get(index).setVisible(true);
                MainFrame_7X7.getGUIedges().get(index).repaint();
                break;
            }
        }
    ...
    public void SavedPlay() {
        for (int i = 0; i < order.size(); i++) {
            kernal7X7_HU_VS_MA.updateArrays(order.get(i));
    ...
    public static void HU_vs_MA() throws Exception{
        ...
        kernal7X7_HU_VS_MA game = new kernal7X7_HU_VS_MA();
