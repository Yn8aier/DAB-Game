...
public class kernal5X5_HU_VS_MA {
...
//                }
    ...
    public void computer1Play() {
        ...
        for (; ; ) {
            ...
            if (isRepeat(index) == true) {
                ...
                kernal5X5_HU_VS_MA.updateArrays(index);
                order.add(index);
    ...
    public void fileread() throws Exception {
        String filepath = System.getProperty("user.dir")+ "/save5.txt";
    ...
    public void SavedPlay() {
        for (int i = 0; i < order.size(); i++) {
            kernal5X5_HU_VS_MA.updateArrays(order.get(i));
            if(MainFrame_5X5.getPlayer() == 1){
                MainFrame_5X5.currentColor = Color.RED;
            }else{
                MainFrame_5X5.currentColor = Color.BLUE;
            }
            MainFrame_5X5.getGUIedges().get(order.get(i)).setColor(MainFrame_5X5.currentColor);
            MainFrame_5X5.getGUIedges().get(order.get(i)).setFree(false);
            MainFrame_5X5.getGUIedges().get(order.get(i)).setVisible(true);
            MainFrame_5X5.getGUIedges().get(order.get(i)).repaint();
            if (testFour(currX, currY, MainFrame_5X5.getPlayer()) == true) {
    ...
    public static void HU_vs_MA() throws Exception{
        ...
        kernal5X5_HU_VS_MA game = new kernal5X5_HU_VS_MA();
